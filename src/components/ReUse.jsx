...
const ReUse = ({ isGreet = true, background = true }) => {
  ...
  // }, []);
   ...
   useGSAP(() => {
    gsap.fromTo(
      ...
      { scale: "1",translateX:"0%" ,duration: 1.6, delay:0.3 } // Ending state with animation duration
    );
  }, []);
  ...
  return (
    <div
      className=" reuse w-full h-[210px] rounded-[6vw] md:rounded-[4vw] md:w-full border-[1px] relative overflow-hidden xs:border-[#e5e5e5] border-[#d2d2d2]    dark:border-[#292929] md:h-[230px] xl:w-[34vw] xl:h-[250px] xl:rounded-[2vw] 2xl:w-[35vw] lg:rounded-[3vw] xs:h-[190px] "
